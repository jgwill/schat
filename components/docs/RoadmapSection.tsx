...
// Manually include ROADMAP.md content here, as direct file import is tricky in this environment
// This content should be kept in sync with the main ROADMAP.md file.
...
const RoadmapSection: React.FC = () => {
  return (
    <section id="roadmap" className="mb-12 p-6 bg-gpt-light rounded-lg shadow-lg">
      <h2 className="text-3xl font-semibold mb-6 text-white border-b border-gpt-gray pb-2">Roadmap</h2>
      <MarkdownRenderer markdown={ROADMAP_CONTENT} />
    </section>
  );
};
